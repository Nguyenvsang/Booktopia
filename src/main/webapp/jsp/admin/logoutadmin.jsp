...
<div class="container d-flex align-items-center justify-content-center vh-100">
    <div class="card text-center">
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/logoutadmin" method="post">
                <button type="submit" class="btn btn-danger">Đăng xuất</button>
                <a href="${pageContext.request.contextPath}/jsp/admin/indexadmin.jsp" class="btn btn-secondary">Không</a>
            </form>
        </div>
    </div>
</div>
