...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-success">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/jsp/aboutus.jsp">Booktopia</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="${pageContext.request.contextPath}/jsp/index.jsp">Trang chủ <span
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="${pageContext.request.contextPath}/jsp/customer/loginaccount.jsp">Đăng nhập</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="${pageContext.request.contextPath}/jsp/customer/registeraccount.jsp">Đăng ký</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </ul>
